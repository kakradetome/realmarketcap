...
- Live Top 100 crypto market page at `/top-100.html`.
- Dominance Top 10 page at `/dominance.html` that ranks assets with an objective scoring model.
...
| Route | Description |
| --- | --- |
| `/` | Homepage with project overview and links to live market experiences. |
