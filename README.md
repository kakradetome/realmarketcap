...
- Modern purple/pink homepage introducing the RealMarketCap experience with links to every active page.
- Live Top 100 crypto market page available directly at `/top-100.html`.
- Dominance Top 10 page available directly at `/dominance.html` that ranks assets with an objective scoring model and real-time dominance reasons.
...
| Route | Description |
| --- | --- |
| `/` | Homepage with the first marketing overview and links to every active page. |
