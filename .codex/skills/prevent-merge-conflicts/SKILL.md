...
2. Run the bundled conflict check script:
   ...
   ```bash
   python3 .codex/skills/prevent-merge-conflicts/scripts/check_merge_conflicts.py
   ```
...
8. Run the project checks required by `AGENTS.md`.
9. Only create or update the PR after the conflict check and project checks pass.
...
- The bundled conflict script exits successfully.
- `npm run lint` passes.
